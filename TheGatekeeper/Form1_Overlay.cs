...
namespace TheGatekeeper
{
    ...
    public partial class Form1
    {
        ...
        private void HandleInteractiveZoneClick(int zoneIndex)
        {
            ...
            OverlayManagerInstance.CurrentCharacter = currentCharacterData;

            switch (zoneIndex)
            {
                case 0: OverlayManagerInstance.ShowDocument(); break;      // Левый верхний – документ
                case 1: OverlayManagerInstance.ShowHeartbeat(); break;     // Левый средний – ЭКГ
                case 2: OverlayManagerInstance.ShowRadiation(); break;     // Левый нижний – дозиметр
                case 3: OverlayManagerInstance.ShowSticker(0); break;      // Стикер 1
                case 4: OverlayManagerInstance.ShowSticker(1); break;      // Стикер 2
                case 5: OverlayManagerInstance.ShowSticker(2); break;      // Стикер 3
                case 6: OverlayManagerInstance.ShowSticker(3); break;      // Стикер 4
                case 7: OverlayManagerInstance.ShowFingerprint(); break;   // Правый экран – сканер отпечатка
                case 8:
                    OverlayManagerInstance.ShowRadio(); break;         // Большое радио
